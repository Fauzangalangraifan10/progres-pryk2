...
const AddPage = {
  ...
  unmount() {
    AddPage.stopCameraStream();
    // Tambahkan cleanup untuk peta dan marker
    if (AddPage._map) {
      AddPage._map.remove(); // Hapus instance peta
      AddPage._map = null;
    }
    AddPage._marker = null; // Reset variabel marker
    console.log('AddPage unmounted, camera and map cleaned up.');
  },
